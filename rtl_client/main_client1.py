...
fft_thread = threading.Thread(target=fft_worker, args=(fft_input_queue, fft_queue, SAMPLE_RATE))
fft_thread.start()
...
async def main():
    global button_color, button_text, is_connected, fft_input_queue, fft_queue
    running = True
